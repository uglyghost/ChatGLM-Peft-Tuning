...
# parser.add_argument("--dataset_path", type=str, default="data/alpaca/dataset.pkl")
...
parser.add_argument("--save_steps", type=int, default=10)                          # checkpoint保存步长
parser.add_argument("--save_total_limit", type=int, default=2)                       # 保存条目数量上限
parser.add_argument("--learning_rate", type=float, default=2e-4)                     # 模型学习率
